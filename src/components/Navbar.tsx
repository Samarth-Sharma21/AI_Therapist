...
const AuthButton = styled.button<{ $variant?: 'primary' | 'secondary' }>`
  background: ${props => 
    props.$variant === 'primary' 
      ? 'linear-gradient(135deg, #303064, #f98e54)' 
      : 'transparent'
  };
  color: ${props => props.$variant === 'primary' ? 'white' : '#303064'};
  border: ${props => props.$variant === 'primary' ? 'none' : '2px solid #303064'};
  ...
  &:hover {
    ...
    box-shadow: ${props => 
      props.$variant === 'primary' 
        ? '0 6px 20px rgba(249, 142, 84, 0.4)' 
        : '0 4px 15px rgba(48, 48, 100, 0.2)'
    };
    background: ${props => 
      props.$variant === 'primary' 
        ? 'linear-gradient(135deg, #303064, #f98e54)' 
                  ...
                  <UserDropdown
                    ...
                    <UserInfo>
                      ...
                      {user.user_metadata?.full_name && (
                        <div className="name">{user.user_metadata.full_name}</div>
                      )}
                    </UserInfo>
